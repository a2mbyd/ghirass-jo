    ...
    return (
        ...
        >
            ...
            <div className="text-text-muted">
                📚 المقررات: <b className="text-text-primary">{totalCourses}</b>
            </div>
            <div className="mt-2 text-text-muted">
                ✅ الساعات المكتملة:{' '}
                <b className="text-text-success">{completedHoursCount}</b>
            </div>
            <div className="mt-2 text-text-muted">
                📊 الإنجاز: <b className="text-text-primary">{progress}%</b>
            </div>
