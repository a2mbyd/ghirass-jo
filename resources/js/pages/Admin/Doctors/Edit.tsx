...
const Edit = ({ doctor, sections }: EditProps) => {
    ...
    const form = useForm<FormData>({
        ...
        section_id: doctor.section_id ? String(doctor.section_id) : '',
        image: null,
        _method: 'PUT',
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post(AdminDoctorController.update.url(doctor.id), {
            forceFormData: true,
        });
    };
            ...
            <div className="animate-fade-in-up mb-8 flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-text-muted">{doctor.name}</p>
                    </div>
                </div>
                <Link
